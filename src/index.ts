...
window.onload = async () => {
  ...
  const cardAll = document.querySelectorAll<HTMLDivElement>('.card')
  cardAll.forEach(function (card) {
    card.addEventListener('click', function () {
      ...
      //     // eventos
      const pokemon__back =
        document.querySelector<HTMLDivElement>('.pokemon__back')
    ...
    const modal__close = document.querySelector<HTMLDivElement>('.modal__close')
